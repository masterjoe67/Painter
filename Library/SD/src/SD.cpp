...
#define PATH_COMPONENT_BUFFER_LEN MAX_COMPONENT_LEN+1
	...
	bool callback_pathExists(SdFile& parentDir,
		const char *filePathComponent, 
		bool /* isLastComponent */,
		void * /* object */) {
		/*
	...
	bool callback_makeDirPath(SdFile& parentDir,
		const char *filePathComponent, 
		bool isLastComponent,
		void *object) {
		/*
	...
	bool callback_remove(SdFile& parentDir,
		const char *filePathComponent, 
		bool isLastComponent,
		void * /* object */) {
		if (isLastComponent) {
	...
	bool callback_rmdir(SdFile& parentDir,
		const char *filePathComponent, 
		bool isLastComponent,
		void * /* object */) {
		if (isLastComponent) {
	...
	bool SDClass::begin(uint32_t clock) {
		if (root.isOpen()) root.close();
